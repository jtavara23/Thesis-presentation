...
\begin{itemize}
	...
	\item<3->Si $L(\theta, D)$ es la función de coste, $\theta$ es el conjunto de parámetros libres y $D$ es un ejemplo de entrenamiento, entonces a la función de pérdida regularizada será:
 	...
 	\item<4->En esta investigación se usó una constante {\bf lambda($\lambda$) = 0.0001}. La regularización L2 incluye los pesos de las capas totalmente conectadas, y normalmente no incluye a los biases (sesgos).
